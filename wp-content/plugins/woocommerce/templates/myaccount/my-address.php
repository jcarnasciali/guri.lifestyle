...
<p>
	<span class="glenglish">The following addresses will be used on the checkout page by default.</span><span class="glfrench">Les adresses ci-dessous seront utilisés à la page de paiement.</span><span class="glportuguese">Os endereços abaixos serão usados na página de Checkout.</span>
</p>
